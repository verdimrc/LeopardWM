...
pub fn hotkey_catalog() -> Vec<HotkeyAction> {
    let mut v = vec![
        ...
        action(
            "toggle_desktop_peek",
            Some("Ctrl+Alt+Shift+'"),
            "Toggle desktop peek (shift focused window right)",
            "Window",
        ),
        action(
            "toggle_desktop_peek_anchored",
            Some("Ctrl+Alt+'"),
            "Toggle desktop peek (keep focused window in place)",
            "Window",
        ),
        action(
            "toggle_overview",
...
pub fn command_for_action(id: &str) -> Option<crate::IpcCommand> {
    ...
    Some(match id {
        ...
        "toggle_desktop_peek" => IpcCommand::ToggleDesktopPeek,
        "toggle_desktop_peek_anchored" => IpcCommand::ToggleDesktopPeekAnchored,
